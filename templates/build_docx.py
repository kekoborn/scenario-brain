...
формат: suffler (по умолчанию) — текст ведущего слово-в-слово для телепромптера;
        oporny — ЗАПАСНОЙ локальный формат: первая фраза абзаца буллетом (это структура).
                 Основной опорный = Google Slides из oporny-units.md (build_slides.py),
                 каждый слайд = одна единица смысла. См. Этап 12 в SKILL.md.
